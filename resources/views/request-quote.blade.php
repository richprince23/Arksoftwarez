...
@section('content')
 ...
 <section class="max-w-2xl mx-auto my-8 p-8 bg-white rounded-lg shadow-md">
    ...
    <form id="inquiryForm" class="space-y-4">
            ...
            <div id="platformSelection" class="hidden">
                ...
                <div class="mt-1 flex items-center">
                    ...
                    <div id="multiplatformPlatforms" class="hidden">
                        ...
                        <input type="checkbox" id="windowsCheckbox" name="platforms[]" value="windows" class="ml-4 mr-2">
        ...
        <!-- Business Details -->
        <div>
            <label for="businessDetails" class="block text-sm font-medium text-gray-700">Other Business Details</label>
            <textarea id="businessDetails" name="businessDetails"
                class="mt-1 p-2 w-full border rounded-md resize-none" rows="4" required></textarea>
        </div>

        <!-- App Description -->
        <div>
            <label for="appDescription" class="block text-sm font-medium text-gray-700">Detailed App Description</label>
        ...
        <div>
            ...
            <input type="email" id="email" name="email" class="mt-1 p-2 w-full border rounded-md" inputmode="email" required>
        </div>

        <!-- Phone Number -->
        <div>
            <label for="phone" class="block text-sm font-medium text-gray-700">Phone Number</label>
            <input type="tel" id="phone" name="phone" class="mt-1 p-2 w-full border rounded-md" inputmode="tel" required>
            <p class="text-sm text-gray-500">Include country code (e.g., +1 for US)</p>
        </div>
        ...
        <div id="domainInput" class="hidden">
            ...
            <input type="text" id="domainName" name="domainName"
                class="mt-1 p-2 w-full border rounded-md" inputmode="url">
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        appTypeSelect.addEventListener('change', function () {
            ...
            platformSelection.classList.toggle('hidden', selectedType !== 'mobile' && selectedType !== 'multiplatform' && selectedType !== 'desktop');
